...
def main():
    ...
    parser.add_argument('--token', '-t', metavar='TOKEN', default=envtoken, type=str, help='Authentication token')
    parser.add_argument('--out', metavar='PATH', type=str, default=OUT_PATH, help='Output folder')
